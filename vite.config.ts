...
module.exports = defineConfig({
  ...
  plugins: [
    ...
    createMpaPlugin({
      pages: [
        ...
        {
          name: "error_404",
          filename: "err_404.html",
          entry: "/src/pages/err_404/main.ts",
          template: "src/pages/err_404/index.html",
        },
        {
          name: "error_500",
          filename: "err_500.html",
          entry: "/src/pages/err_500/main.ts",
          template: "src/pages/err_500/index.html",
        },
        {
          name: "error_503",
          filename: "err_503.html",
          entry: "/src/pages/err_503/main.ts",
          template: "src/pages/err_503/index.html",
        },
      ],
    }),
  ],
  server: {
    ...
    proxy: {
      // with options
      "/api": {
        target: "https://preview.app.w-shops.com/api",
        xfwd: true,
        changeOrigin: true,
